# DeadAir Economy Overhaul — mlog4 fork (X4 9.x compatibility)

> **This is a community-maintained compatibility fork** of DeadAir Economy Overhaul, continuing the mod after the original author retired (2025-09-23) under the GPL-3.0 licence he provided. The original gameplay logic is preserved unchanged; this fork only fixes compatibility issues with X4 Foundations 9.x. **Tested on X4 9.0 beta 7.**
>
...
>
> Companion mod (required): [DeadAir Scripts — mlog4 fork](https://github.com/mlog4/deadair_scripts). They are tested as a pair.
>
> ---
